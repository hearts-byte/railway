    ...
    <div class="page_element">
        ...
        <div class="config_section">
            <script data-cfasync="false" type="text/javascript">
                var aaFrameConfigSaved = 'Ustawienia zostaly zapisane';
                var aaFrameConfigError = 'Nie udalo sie zapisac ustawien';
                saveSettings = function() {
                    $.post('addons/AA_photo_frame/system/action.php', {
                        ...
                        if (response == 1) {
                            callSaved(aaFrameConfigSaved, 1);
                        } else {
                            callSaved(aaFrameConfigError, 3);
                        }
                    });
                }
            </script>
