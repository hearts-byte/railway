...
if (!boomAllow($addons['custom1']) || !boomAllow($addons['addons_access'])) {
	die();
}
?>
<div class="brow">
...
<div class="pad10">
	...
	<div data="<?php echo $target; ?>" style="padding: 0;" class="centered_element ulist_container found_user_frame">
		<div class="gift-responsive" onclick="delPhotoFrameStaff()" value="n-fr-mlky">
		...
		<div class="gift-responsive" onclick="savePhotoFrameStaff('dragon.webp')" value="dragon">
			<div class="gift-container">
				<div style="height:60px;">
		...
		<div class="gift-responsive" onclick="savePhotoFrameStaff('n-fr-mlky.webp')" value="n-fr-mlky">
			<div class="gift-container">
				<div style="height:60px;">
		...
		<div class="gift-responsive" onclick="savePhotoFrameStaff('n-fr1.webp')" value="n-fr1">
			<div class="gift-container">
				<div style="height:60px;">
		...
		<div class="gift-responsive" onclick="savePhotoFrameStaff('n-fr2.webp')" value="n-fr2">
			<div class="gift-container">
				<div style="height:60px;">
		...
		<div class="gift-responsive" onclick="savePhotoFrameStaff('n-fr3.webp')" value="n-fr3">
			<div class="gift-container">
				<div style="height:60px;">
		...
		<div class="gift-responsive" onclick="savePhotoFrameStaff('n-fr4.webp')" value="n-fr4">
			<div class="gift-container">
				<div style="height:60px;">
		...
		<div class="gift-responsive" onclick="savePhotoFrameStaff('n-fr5.webp')" value="n-fr5">
			<div class="gift-container">
				<div style="height:60px;">
		...
		<div class="gift-responsive" onclick="savePhotoFrameStaff('n-fr6.webp')" value="n-fr6">
			<div class="gift-container">
				<div style="height:60px;">
		...
		<div class="gift-responsive" onclick="savePhotoFrameStaff('n-fr7.webp')" value="n-fr7">
			<div class="gift-container">
				<div style="height:60px;">
		...
		<div class="gift-responsive" onclick="savePhotoFrameStaff('n-fr8.webp')" value="n-fr8">
			<div class="gift-container">
				<div style="height:60px;">
		...
		<div class="gift-responsive" onclick="savePhotoFrameStaff('n-fr9.webp')" value="n-fr9">
			<div class="gift-container">
				<div style="height:60px;">
		...
		<div class="gift-responsive" onclick="savePhotoFrameStaff('n-fr10.webp')" value="n-fr10">
			<div class="gift-container">
				<div style="height:60px;">
		...
		<div class="gift-responsive" onclick="savePhotoFrameStaff('n-fr11.webp')" value="n-fr11">
			<div class="gift-container">
				<div style="height:60px;">
		...
		<div class="gift-responsive" onclick="savePhotoFrameStaff('n-fr13.webp')" value="n-fr13">
			<div class="gift-container">
				<div style="height:60px;">
		...
		<div class="gift-responsive" onclick="savePhotoFrameStaff('n-fr14.gif')" value="n-fr14">
			<div class="gift-container">
				<div style="height:60px;">
		...
		<div class="gift-responsive" onclick="savePhotoFrameStaff('n-fr12.png')" value="n-fr12">
			<div class="gift-container">
				<div style="height:60px;">
		...
		<div class="gift-responsive" onclick="savePhotoFrameStaff('n-fr17.png')" value="n-fr17">
			<div class="gift-container">
				<div style="height:60px;">
		...
		<div class="gift-responsive" onclick="savePhotoFrameStaff('n-fr19.png')" value="n-fr19">
			<div class="gift-container">
				<div style="height:60px;">
		...
		<div class="gift-responsive" onclick="savePhotoFrameStaff('n-fr24.png')" value="n-fr24">
			<div class="gift-container">
				<div style="height:60px;">
		...
		<div class="gift-responsive" onclick="savePhotoFrameStaff('n-fr27.png')" value="n-fr27">
			<div class="gift-container">
				<div style="height:60px;">
		...
		<div class="gift-responsive" onclick="savePhotoFrameStaff('n-fr28.png')" value="n-fr28">
			<div class="gift-container">
				<div style="height:60px;">
		...
		<div class="gift-responsive" onclick="savePhotoFrameStaff('frame1.png')" value="frame1">
			<div class="gift-container">
				<div style="height:60px;">
		...
		<div class="gift-responsive" onclick="savePhotoFrameStaff('frame2.png')" value="frame2">
			<div class="gift-container">
				<div style="height:60px;">
		...
		<div class="gift-responsive" onclick="savePhotoFrameStaff('frame33.png')" value="frame33">
			<div class="gift-container">
				<div style="height:60px;">
		...
		<div class="gift-responsive" onclick="savePhotoFrameStaff('frame4.png')" value="frame4">
			<div class="gift-container">
				<div style="height:60px;">
		...
		<div class="gift-responsive" onclick="savePhotoFrameStaff('frame5.png')" value="frame5">
			<div class="gift-container">
				<div style="height:60px;">
		...
		<div class="gift-responsive" onclick="savePhotoFrameStaff('frame6.png')" value="frame6">
			<div class="gift-container">
				<div style="height:60px;">
		...
		<div class="gift-responsive" onclick="savePhotoFrameStaff('frame7.png')" value="frame7">
			<div class="gift-container">
				<div style="height:60px;">
		...
		<div class="gift-responsive" onclick="savePhotoFrameStaff('frame8.png')" value="frame8">
			<div class="gift-container">
				<div style="height:60px;">
		...
		<div class="gift-responsive" onclick="savePhotoFrameStaff('frame9.png')" value="frame9">
			<div class="gift-container">
				<div style="height:60px;">
		...
		<div class="gift-responsive" onclick="savePhotoFrameStaff('frame10.png')" value="frame10">
			<div class="gift-container">
				<div style="height:60px;">
		...
		<div class="gift-responsive" onclick="savePhotoFrameStaff('frame11.png')" value="frame11">
			<div class="gift-container">
				<div style="height:60px;">
		...
		<div class="gift-responsive" onclick="savePhotoFrameStaff('pink-frame.png')" value="pink-frame">
			<div class="gift-container">
				<div style="height:60px;">
		...
		<div class="gift-responsive" onclick="savePhotoFrameStaff('frame120.png')" value="frame120">
			<div class="gift-container">
				<div style="height:60px;">
		...
		<div class="gift-responsive" onclick="savePhotoFrameStaff('frame130.png')" value="frame130">
			<div class="gift-container">
				<div style="height:60px;">
		...
		<div class="gift-responsive" onclick="savePhotoFrameStaff('frame1400.png')" value="frame1400">
			<div class="gift-container">
				<div style="height:60px;">
		...
		<div class="gift-responsive" onclick="savePhotoFrameStaff('frame1500.png')" value="frame1500">
			<div class="gift-container">
				<div style="height:60px;">
		...
		<div class="gift-responsive" onclick="savePhotoFrameStaff('frame160.png')" value="frame160">
			<div class="gift-container">
				<div style="height:60px;">
		...
		<div class="gift-responsive" onclick="savePhotoFrameStaff('frame170.png')" value="frame170">
			<div class="gift-container">
				<div style="height:60px;">
		...
		<div class="gift-responsive" onclick="savePhotoFrameStaff('frame1810.png')" value="frame1810">
			<div class="gift-container">
				<div style="height:60px;">
		...
		<div class="gift-responsive" onclick="savePhotoFrameStaff('frame190.png')" value="frame190">
			<div class="gift-container">
				<div style="height:60px;">
		...
		<div class="gift-responsive" onclick="savePhotoFrameStaff('frame200.png')" value="frame200">
			<div class="gift-container">
				<div style="height:60px;">
		...
		<div class="gift-responsive" onclick="savePhotoFrameStaff('frame2110.png')" value="frame2110">
			<div class="gift-container">
				<div style="height:60px;">
		...
		<div class="gift-responsive" onclick="savePhotoFrameStaff('flower-frame.png')" value="flower-frame">
			<div class="gift-container">
				<div style="height:60px;">
		...
		<div class="gift-responsive" onclick="savePhotoFrameStaff('caty-frame.png')" value="caty-frame">
			<div class="gift-container">
				<div style="height:60px;">
		...
		<div class="gift-responsive" onclick="savePhotoFrameStaff('hat-frame.png')" value="hat-frame">
			<div class="gift-container">
				<div style="height:60px;">
		...
		<div class="gift-responsive" onclick="savePhotoFrameStaff('star-frame.png')" value="star-frame">
			<div class="gift-container">
				<div style="height:60px;">
		...
		<div class="gift-responsive" onclick="savePhotoFrameStaff('santa-frame.png')" value="santa-frame">
			<div class="gift-container">
				<div style="height:60px;">
...
<script data-cfasync="false" type="text/javascript">
	savePhotoFrameStaff = function(frame) {
		var target = $('.found_user_frame').attr('data');
		$.post('addons/AA_photo_frame/system/action.php', {
			set_photo_frame_staff: frame,
			frame_target_staff: target,
			token: utk
		}, function(response) {
			if (response == 1) {
				aaFrameSetLocal(target, frame);
	...
	delPhotoFrameStaff = function(frame) {
		var target = $('.found_user_frame').attr('data');
		$.post('addons/AA_photo_frame/system/action.php', {
			del_frame_target_staff: target,
			token: utk
		}, function(response) {
			if (response == 1) {
				aaFrameSetLocal(target, '');
				aaFrameRefresh(aaFrameApplyAll);
