<div class="post_input_container bhover gcard select_gift gift_bg" data-img="addons/<?php echo BOOM_ADDONS; ?>/files/frames/<?php echo $boom['tumb']; ?>" data-price="<?php echo $boom['price']; ?>" data-id="<?php echo $boom['id']; ?>" onclick="adminEditFrame(<?php echo $boom['id']; ?>);">
