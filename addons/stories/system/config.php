...
define('STORIES_DURATION_HOURS', 24);   // مدة بقاء الستوري
define('STORIES_GOLD_ENABLED', true);   // تفعيل/تعطيل خيار الربط بالذهب
define('STORIES_GOLD_COST_DEFAULT', 0); // 0 = نشر مجاني افتراضياً
