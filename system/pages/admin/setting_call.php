	...
	<div id="call_tab">
		<div id="call_zone" class="tab_zone">
			...
			<div class="page_element">
				...
				<div class="form_content">
					<div class="setting_element ">
						<p class="label"><?php echo $lang['can_agcall']; ?></p>
						<select id="set_can_agcall">
							<?php echo listRank($setting['can_agcall']); ?>
						</select>
					</div>
					<div class="setting_element ">
						<p class="label"><?php echo $lang['can_vgcall']; ?></p>
						<select id="set_can_vgcall">
							<?php echo listRank($setting['can_vgcall']); ?>
						</select>
					</div>
					<div class="setting_element ">
